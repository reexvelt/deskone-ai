...
function StudioPage() {
  ...
  return (
    <div className="space-y-6 pb-10">
      <section className="rounded-[2rem] border border-border bg-surface/50 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:p-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/60 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">
      ...
      <section className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="space-y-6">
          <div className="rounded-[2rem] border border-border bg-surface/50 p-5 backdrop-blur-xl sm:p-6">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-secondary/20 to-primary/20">
                <CloudUpload className="h-5 w-5 text-foreground" />
              </div>
              <div>
                <h2 className="text-xl font-semibold">Upload content</h2>
                <p className="text-sm text-muted-foreground">Drag, drop, or browse your files.</p>
              </div>
            </div>

            <div
              className="mt-5 rounded-[1.75rem] border border-dashed border-border bg-background p-6 transition hover:border-border"
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center gap-3 text-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-secondary/15 to-primary/15">
                  <CloudUpload className="h-6 w-6 text-foreground" />
                </div>
                <div>
                  <p className="text-sm font-medium">Drop your video, audio, images, or document here</p>
                  <p className="mt-1 text-xs text-muted-foreground">Supported formats for the first V1 workflow</p>
                </div>
                <button
                  type="button"
                  onClick={() => fileInputRef.current?.click()}
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-secondary to-primary px-5 py-3 text-sm font-semibold text-foreground transition hover:translate-y-[-1px]"
                >
                  Browse files
                </button>
              </div>
          ...
          <div className="rounded-[2rem] border border-border bg-surface/50 p-5 backdrop-blur-xl sm:p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Choose where this studio work belongs.</p>
              </div>
            </div>
          ...
          <div className="rounded-[2rem] border border-border bg-gradient-to-br from-secondary/12 to-primary/10 p-5 backdrop-blur-xl sm:p-6">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-surface/60">
                <Clock3 className="h-5 w-5 text-foreground" />
              </div>
              <div>
                <h2 className="text-xl font-semibold">Publishing</h2>
                <p className="text-sm text-muted-foreground">Prepare the content for publishing or schedule it.</p>
              </div>
            </div>

            <div className="mt-5 grid gap-4">
              <label className="space-y-2">
                <span className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Schedule label</span>
                <input
                  value={scheduledDate}
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-surface/60 px-4 py-3 text-sm font-semibold text-foreground transition hover:bg-surface"
                >
                ...
                <button
                  type="button"
                  onClick={publishNow}
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-secondary to-primary px-4 py-3 text-sm font-semibold text-foreground transition hover:translate-y-[-1px]"
                >
        ...
        <div className="rounded-[2rem] border border-border bg-surface/50 p-5 backdrop-blur-xl sm:p-6">
          <div className="flex flex-col gap-4 border-b border-border pb-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Generate</p>
              <h2 className="mt-2 text-2xl font-bold">AI content outputs</h2>
              <p className="mt-1 text-sm text-muted-foreground">Generate and approve outputs before publishing.</p>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-secondary to-primary px-5 py-3 text-sm font-semibold text-foreground transition hover:translate-y-[-1px] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isGenerating ? (
                <>
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition ${
                  outputTab === key
                    ...
                    : "border border-border bg-surface/60 text-muted-foreground hover:bg-surface"
                }`}
              >
          ...
          <div className="mt-5 rounded-[1.75rem] border border-border bg-background p-5">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-border bg-background p-4">
              <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Project</p>
          ...
          {files.length > 0 && (
            <div className="mt-5 rounded-2xl border border-border bg-background p-4">
              <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Uploaded files</p>
              <div className="mt-3 space-y-2">
                {selectedFileNames.map((item) => (
                  <div key={item} className="rounded-xl border border-border bg-surface/50 px-3 py-2 text-sm text-muted-foreground">
                    {item}
                  </div>
                ))}
              </div>
